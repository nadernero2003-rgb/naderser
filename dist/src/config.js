...
export const SERVICES = [
    { name: "خدمة B.C", icon: "fa-book-bible", color: "teal" },
    { name: "خدمة KG", icon: "fa-child-reaching", color: "lime" },
    { name: "خدمة أولى ابتدائي", icon: "fa-shapes", color: "green" },
    { name: "خدمة ثانية ابتدائي", icon: "fa-pencil-ruler", color: "yellow" },
    { name: "خدمة ثالثة ورابعة بنات", icon: "fa-female", color: "pink" },
    { name: "خدمة ثالثة ورابعة أولاد", icon: "fa-male", color: "indigo" },
    { name: "خدمة خامسة وسادسة بنات", icon: "fa-palette", color: "red" },
    { name: "خدمة خامسة وسادسة أولاد", icon: "fa-futbol", color: "purple" },
    { name: "خدمة الكورال والأنشطة", icon: "fa-music", color: "cyan" },
    { name: "خدمة وسائل الإيضاح", icon: "fa-desktop", color: "orange" },
    {
        name: "الامين العام",
        icon: "fa-user-shield",
        color: "blue",
